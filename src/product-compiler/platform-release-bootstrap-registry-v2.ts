...
import { PlatformReleaseBootstrapPackageRefV2Schema } from "../execution/schemas/platform-release-bootstrap-operation-abis-v2.js";
import {
...
export const PLATFORM_RELEASE_BOOTSTRAP_NAMESPACE_CENSUS_MAX_ENTRIES_V2 = 16_384;
...
export const PlatformReleaseBootstrapNamespaceClassificationV2Schema = z
...
export type PlatformReleaseBootstrapNamespaceClassificationV2 = z.infer<
  typeof PlatformReleaseBootstrapNamespaceClassificationV2Schema
>;

export type PlatformReleaseBootstrapNamespaceClassificationHashPayloadV2 = Omit<
...
export const PlatformReleaseBootstrapNamespaceCensusV2Schema = z
  .object({
    schema: z.literal(PLATFORM_RELEASE_BOOTSTRAP_NAMESPACE_CENSUS_V2_SCHEMA),
    version: z.literal(PLATFORM_RELEASE_COMPONENT_VERSION_V2),
  ...
  .superRefine((value, context) => {
    ...
    if (
      value.censusHash !== hashPlatformReleaseBootstrapNamespaceCensusV2(value)
    ) {
      context.addIssue({
        code: "custom",
        path: ["censusHash"],
...
export type PlatformReleaseBootstrapNamespaceCensusV2 = z.infer<
  typeof PlatformReleaseBootstrapNamespaceCensusV2Schema
>;

export type PlatformReleaseBootstrapNamespaceCensusHashPayloadV2 = Omit<
...
export class PlatformReleaseBootstrapNamespaceClassificationErrorV2 extends TypeError {
  readonly code: PlatformReleaseBootstrapNamespaceClassificationErrorCodeV2;
  ...
  constructor(
    ...
    super(message);
    this.name = "PlatformReleaseBootstrapNamespaceClassificationErrorV2";
    this.code = code;
    this.basename = basename;
  }
}

type PackageRefV2 = z.infer<typeof PlatformReleaseBootstrapPackageRefV2Schema>;
...
type NamespaceMatcherV2 = NamespaceEntryMatchV2 &
  Readonly<{
...
function buildNamespaceMatchersV2(): readonly NamespaceMatcherV2[] {
  ...
  const matchers: NamespaceMatcherV2[] = [
    exactMatcherV2(contract.registry.filesystemScopeBasename, {
      ownerKind: "registry",
    ...
    exactMatcherV2(contract.registry.activationClaimBasename, {
      ownerKind: "registry",
      ownerRef: REGISTRY_REF_V2,
      category: "activation_claim",
      matchKind: "exact_basename",
    }),
    exactMatcherV2(contract.registry.transactionStagingBasename, {
      ownerKind: "registry",
      ownerRef: REGISTRY_REF_V2,
      category: "transaction_staging",
      matchKind: "exact_basename",
    }),
  ...
  for (const packageContract of contract.packages) {
    ...
    const packageEntries = [
      ...
      [packageContract.lifecycle.activeReceiptBasename, "active_receipt"],
...
function matchingNamespaceEntriesV2(
  ...
  return NAMESPACE_MATCHERS_V2.filter((matcher) =>
    matcher.matches(basename),
  ).map(
    (matcher) =>
      Object.freeze({
...
function assertCodeOwnedNamespaceIsDisjointV2(): void {
  ...
  for (const packageContract of PLATFORM_RELEASE_BOOTSTRAP_CONTRACT_V2.packages) {
    if (
      matchingNamespaceEntriesV2(packageContract.lifecycle.stagingPrefix)
        .length !== 0
    ) {
      throw new PlatformReleaseBootstrapNamespaceClassificationErrorV2(
        "PLATFORM_RELEASE_BOOTSTRAP_NAMESPACE_V2_REGISTRY_INVALID",
...
export function classifyPlatformReleaseBootstrapNamespaceBasenameV2(
  ...
  const classificationWithoutHash = {
    schema: PLATFORM_RELEASE_BOOTSTRAP_NAMESPACE_CLASSIFICATION_V2_SCHEMA,
    version: PLATFORM_RELEASE_COMPONENT_VERSION_V2,
    namespaceContractHash: PLATFORM_RELEASE_BOOTSTRAP_CONTRACT_V2.contractHash,
  ...
  return deepFreezePlatformReleaseJsonV2(
    PlatformReleaseBootstrapNamespaceClassificationV2Schema.parse({
      ...
      classificationHash: hashPlatformReleaseBootstrapNamespaceClassificationV2(
        classificationWithoutHash,
      ),
    }),
  );
...
export function classifyPlatformReleaseBootstrapNamespaceCensusV2(
  ...
  for (const basename of basenames) {
    if (
      names.length >= PLATFORM_RELEASE_BOOTSTRAP_NAMESPACE_CENSUS_MAX_ENTRIES_V2
    ) {
      throw new PlatformReleaseBootstrapNamespaceClassificationErrorV2(
        "PLATFORM_RELEASE_BOOTSTRAP_NAMESPACE_V2_CENSUS_TOO_LARGE",
