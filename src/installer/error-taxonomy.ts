...
const PATTERNS: Array<{ pattern: RegExp; category: ErrorCategory; suggestion: string }> = [
  ...
  { pattern: /^GENERATED_SCREEN_SHELL_LANDMARK_UNSAFE:/i, category: "GENERATED_SCREEN_SHELL_LANDMARK_UNSAFE", suggestion: "Remove app-shell semantic landmark wrappers around generated full-screen Stitch screens. Generated screens own their main landmark; use a neutral div data-setfarm-root container for app state wiring." },
  { pattern: /^GENERATED_SCREEN_LAYOUT_MOUNT_UNSAFE:/i, category: "GENERATED_SCREEN_LAYOUT_MOUNT_UNSAFE", suggestion: "Generated full-screen screens with sibling sidebar/content layouts must be mounted inside a neutral flex data-setfarm-root viewport container. Prefer a combined root such as className=\"relative flex min-h-screen w-full overflow-hidden\" when generated screens also use absolute/fixed viewport layers. Preserve generated screen structure and fix the app/root wrapper instead of rewriting generated screens." },
  { pattern: /^GENERATED_SCREEN_VIEWPORT_MOUNT_UNSAFE:/i, category: "GENERATED_SCREEN_VIEWPORT_MOUNT_UNSAFE", suggestion: "Generated absolute/fixed full-screen screens must be mounted inside a neutral positioned viewport root. Prefer a combined root such as className=\"relative flex min-h-screen w-full overflow-hidden\" so sibling sidebar/content generated screens also render side-by-side. Fix the app/root wrapper instead of rewriting generated screens." },
