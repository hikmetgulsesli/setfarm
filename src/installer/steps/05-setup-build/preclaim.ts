...
import {
  ...
  type SetupBuildPacketErrorCode,
...
export const SETUP_BUILD_PACKET_OPERATIONAL_FAILURE_CODE_BY_ERROR_CODE_V3 = Object.freeze({
  SETUP_PACKET_ACTIVATION_REJECTED: "SETUP_PACKET_ACTIVATION_REJECTED",
  SETUP_PACKET_DESIGN_GRAPH_REJECTED: "SETUP_PACKET_DESIGN_GRAPH_REJECTED",
  SETUP_PACKET_DESIGN_SOURCE_ATTEMPT_REJECTED: "SETUP_PACKET_DESIGN_SOURCE_ATTEMPT_REJECTED",
  SETUP_PACKET_DESIGN_SOURCE_CLOSURE_REJECTED: "SETUP_PACKET_DESIGN_SOURCE_CLOSURE_REJECTED",
  SETUP_PACKET_DIRECT_RESPONSE_EVIDENCE_REJECTED: "SETUP_PACKET_DIRECT_RESPONSE_EVIDENCE_REJECTED",
  SETUP_PACKET_DELIVERY_PROFILE_REJECTED: "SETUP_PACKET_DELIVERY_PROFILE_REJECTED",
  SETUP_PACKET_ENTRYPOINT_AMBIGUOUS: "SETUP_PACKET_ENTRYPOINT_AMBIGUOUS",
  SETUP_PACKET_ENTRYPOINT_MISSING: "SETUP_PACKET_ENTRYPOINT_MISSING",
  SETUP_PACKET_FILE_INVALID: "SETUP_PACKET_FILE_INVALID",
  SETUP_PACKET_GENERATED_SOURCE_AMBIGUOUS: "SETUP_PACKET_GENERATED_SOURCE_AMBIGUOUS",
  SETUP_PACKET_GENERATED_SOURCE_MISSING: "SETUP_PACKET_GENERATED_SOURCE_MISSING",
  SETUP_PACKET_GENERATED_SOURCE_TOPOLOGY_MISSING: "SETUP_PACKET_GENERATED_SOURCE_TOPOLOGY_MISSING",
  SETUP_PACKET_IMPLEMENTATION_SOURCE_MAP_REJECTED: "SETUP_PACKET_IMPLEMENTATION_SOURCE_MAP_REJECTED",
  SETUP_PACKET_JSON_INVALID: "SETUP_PACKET_JSON_INVALID",
  SETUP_PACKET_PLAN_REJECTED: "SETUP_PACKET_PLAN_REJECTED",
  SETUP_PACKET_PROTOCOL_MISMATCH: "SETUP_PACKET_PROTOCOL_MISMATCH",
  SETUP_PACKET_REPO_DIRTY: "SETUP_PACKET_REPO_DIRTY",
  SETUP_PACKET_REPO_IDENTITY_INVALID: "SETUP_PACKET_REPO_IDENTITY_INVALID",
  SETUP_PACKET_RUNTIME_EVIDENCE_REJECTED: "SETUP_PACKET_RUNTIME_EVIDENCE_REJECTED",
  SETUP_PACKET_RUN_ID_MISMATCH: "SETUP_PACKET_RUN_ID_MISMATCH",
  SETUP_PACKET_SEMANTICS_VERSION_MISMATCH: "SETUP_PACKET_PROTOCOL_MISMATCH",
  SETUP_PACKET_SOURCE_NON_CANONICAL: "SETUP_PACKET_SOURCE_NON_CANONICAL",
  SETUP_PACKET_STORY_PLAN_REJECTED: "SETUP_PACKET_STORY_PLAN_REJECTED",
  SETUP_PACKET_TOPOLOGY_OWNER_AMBIGUOUS: "SETUP_PACKET_TOPOLOGY_OWNER_AMBIGUOUS",
  SETUP_PACKET_TOPOLOGY_REJECTED: "SETUP_PACKET_TOPOLOGY_REJECTED",
} satisfies Readonly<Record<SetupBuildPacketErrorCode, string>>);

export function setupBuildPacketOperationalFailureCode(
  error: SetupBuildPacketError,
): string {
  return SETUP_BUILD_PACKET_OPERATIONAL_FAILURE_CODE_BY_ERROR_CODE_V3[error.code];
}
