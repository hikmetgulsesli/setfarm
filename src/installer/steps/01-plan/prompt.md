...
2. Choose PLATFORM, TECH_STACK, DB_REQUIRED, and DESIGN_REQUIRED. UI_LANGUAGE is always English.
...
The source task may use or request another language. Translate its product
intent into English and keep every planner-owned product name, visible label,
message, UI copy, and technical field in English.
