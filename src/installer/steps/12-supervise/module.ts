...
function buildPrompt(ctx: PromptContext): string {
  ...
  const resolved = resolveTemplate(promptTemplate, {
    ...
    SUPERVISOR_INTERVENTIONS: c["supervisor_interventions"] || "(no supervisor interventions)",
    SUPERVISOR_VISUAL_REPORT: c["supervisor_visual_report"] || "(no supervisor visual QA report)",
