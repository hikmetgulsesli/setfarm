...
export const STEP_CONTEXT_ALLOWLIST: Record<string, string[]> = {
  ...
  stories: ["prd", "screen_map", "design_tokens", "design_system", "design_manifest", "design_dom_preview", "ui_behavior_contract", "predicted_screen_files", "stitch_project_id"],
  "setup-repo": ["prd", "design_tokens", "screen_map", "stack_contract", "stack_pack_id", "stack_prompt", "stack_setup_contract"],
  "setup-build": ["prd", "baseline", "design_tokens", "design_system", "stack_contract", "stack_pack_id", "stack_prompt", "stack_setup_contract", "stack_verification_contract"],
  implement: [
    ...
    "screen_map", "story_screens", "ui_contract", "ui_behavior_contract", "layout_skeleton",
