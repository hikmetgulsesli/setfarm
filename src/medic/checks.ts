...
const STEP_STUCK_THRESHOLD_MS: Record<string, number> = {
  ...
  stories:        10 * 60 * 1000,   // 10 min - story JSON generation + predicted_screens (2026-04-16: 6 to 10)
...
const STORY_STUCK_THRESHOLD_MS = 20 * 60 * 1000; // 20 min (Wave 16 revert: 10min was too aggressive — coding stories need headroom)
...
const GATEWAY_STALL_WINDOW_MS = 20 * 60 * 1000; // 20 min window accommodates long dev claim sessions.
