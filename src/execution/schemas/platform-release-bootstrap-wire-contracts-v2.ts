...
const wireSchemaIdentitiesV2 = [
  ...
  success("setfarm.platform-release-metadata-probe-receipt.v2", [
    ...
    field("targetEntryNamesHash", "sha256"),
    field("stableMetadataProjectionHash", "sha256"),
  ...
  success("setfarm.platform-release-network-negative-probe-receipt.v2", [
    ...
    field("targetRootPhysicalIdentityHash", "sha256"),
    field("sandboxPolicyHash", "sha256"),
    field("sandboxProfileHash", "sha256"),
    field("probeProgramHash", "sha256"),
    field("normalizedEnvironmentHash", "sha256"),
    field("probeClosureHash", "sha256"),
    ...
    field("controlSetHash", "sha256"),
    field("stableNetworkProjectionHash", "sha256"),
