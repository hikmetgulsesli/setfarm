...
} from "../../product-compiler/schemas/node-toolchain-provisioner-bootstrap-installation-state-v2.js";
import {
...
} from "../../product-compiler/schemas/node-toolchain-provisioner-bootstrap-rollback-v2.js";
import {
...
} from "../../product-compiler/schemas/node-toolchain-provisioner-bootstrap-v2.js";
import {
  Sha256Schema,
...
export const PLATFORM_RELEASE_BOOTSTRAP_FILESYSTEM_SCOPE_DOCUMENT_BASENAME_V2 =
  "setfarm-bootstrap-filesystem-scope-v2.json" as const;
...
export const PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_ACTIVATION_CLAIM_BASENAME_V2 =
  ".setfarm-bootstrap-package-registry-v2.activation-claim.v2.json" as const;
export const PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_TRANSACTION_STAGING_BASENAME_V2 =
  ".setfarm-bootstrap-package-registry-v2.transaction-staging.v2" as const;
...
export const PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_ACTIVATION_CLAIM_V2_SCHEMA =
  "setfarm.platform-release-bootstrap-registry-activation-claim.v2" as const;
...
export const PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_COUNT_V2 = 5;
...
const activationMigratorProtocolIdentityV2 = {
  schema:
    "setfarm.platform-release-bootstrap-registry-activation-migrator-protocol.v2",
  version: PLATFORM_RELEASE_COMPONENT_VERSION_V2,
  preReceiptLockOrder: "legacy_node_then_shared_parent_v2",
  postReceiptCleanupLockOrder: "shared_parent_then_legacy_node_v2",
  steadyStateAdmissionPolicy:
    "activation_claim_and_transaction_staging_absent_v2",
  cleanupMemberOrder: [
    "staged_activation_receipt",
    "staged_genesis_epoch_state",
    "staged_shared_lock",
  ],
  partialCleanupCensusPolicy:
    "setfarm.platform-release-bootstrap-registry-activation-cleanup-remaining-census.v2",
  stagingPolicy: "fixed_transaction_staging_claim_before_final_receipt_last_v2",
  recoveryPolicy:
    "exact_activation_claim_required_for_shared_or_genesis_resume_v2",
  completionPolicy:
    "activation_receipt_then_staging_cleanup_then_claim_removal_v2",
} as const;

export const PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_ACTIVATION_MIGRATOR_PROTOCOL_HASH_V2 =
  hashCanonicalJson(activationMigratorProtocolIdentityV2);
...
const RegistryDocumentFieldDefinitionV2Schema = z
  .object({
    name: z
      .string()
      .min(1)
...
const RegistryDocumentProtocolIdentityV2Schema = z
  .object({
    schema: z.literal(
    ...
    purpose: z.enum([
      "claim_first_crash_safe_shared_registry_cutover_v2",
    ...
    relationPolicy: z.enum([
      "activation_claim_binds_transaction_migrator_cutover_genesis_and_expected_receipt_v2",
    ...
    fields: z.array(RegistryDocumentFieldDefinitionV2Schema).min(1).max(24),
  })
  .strict()
  .superRefine((value, context) => {
...
export const PlatformReleaseBootstrapRegistryDocumentProtocolV2Schema =
  RegistryDocumentProtocolIdentityV2Schema.extend({
    ...
    .strict()
    .superRefine((value, context) => {
      const exactCanonical = exactRegistryDocumentProtocolCanonicalByRefV2?.get(
        value.schemaRef,
      );
      if (
        value.documentSchemaHash !==
          hashPlatformReleaseBootstrapRegistryDocumentProtocolV2(value) ||
...
export type PlatformReleaseBootstrapRegistryDocumentProtocolV2 = z.infer<
  typeof PlatformReleaseBootstrapRegistryDocumentProtocolV2Schema
>;

type RegistryDocumentFieldDefinitionV2 = z.infer<
  typeof RegistryDocumentFieldDefinitionV2Schema
>;
...
const registryDocumentProtocolIdentitiesV2 = [
  {
    schema: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_V2_SCHEMA,
    schemaRef: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_ACTIVATION_CLAIM_V2_SCHEMA,
    documentKind: "activation_claim",
    purpose: "claim_first_crash_safe_shared_registry_cutover_v2",
    ...
    fields: [
      ...
      registryDocumentField("migratorProtocolHash", "sha256"),
      ...
      registryDocumentField("nodeLifecycleSnapshotHash", "sha256"),
      registryDocumentField("parentIdentityHash", "sha256"),
      registryDocumentField("preActivationNamespaceCaptureHash", "sha256"),
      registryDocumentField("transactionStagingIdentityHash", "sha256"),
      registryDocumentField("transactionStagingCensusHash", "sha256"),
      registryDocumentField("genesisEpochStateHash", "sha256"),
      registryDocumentField("expectedActivationReceiptHash", "sha256"),
      registryDocumentField("activationClaimHash", "sha256"),
    ],
  },
  {
    schema: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_V2_SCHEMA,
    schemaRef: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_ACTIVATION_RECEIPT_V2_SCHEMA,
    documentKind: "activation_receipt",
    purpose: "irreversible_shared_registry_cutover_receipt_last_v2",
    encoding: "strict_bounded_canonical_json_utf8_v2",
    maxCanonicalBytes: 128 * 1024,
    productionUse: "forbidden",
    relationPolicy:
  ...
  {
    schema: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_V2_SCHEMA,
    schemaRef: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_EPOCH_CLAIM_V2_SCHEMA,
    documentKind: "epoch_claim",
    purpose: "claim_first_single_package_epoch_floor_transaction_v2",
    encoding: "strict_bounded_canonical_json_utf8_v2",
    maxCanonicalBytes: 128 * 1024,
    productionUse: "forbidden",
    relationPolicy:
    ...
    fields: [
      ...
      registryDocumentField("priorEpochState", "exact_epoch_floor_state"),
      registryDocumentField("targetEpochState", "exact_epoch_floor_state"),
      registryDocumentField("transactionStagingIdentityHash", "sha256"),
      registryDocumentField("transactionStagingCensusHash", "sha256"),
  ...
  {
    schema: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_V2_SCHEMA,
    schemaRef: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_EPOCH_FLOOR_STATE_V2_SCHEMA,
    documentKind: "epoch_floor_state",
    purpose: "sole_receipt_last_monotonic_distribution_epoch_floor_v2",
    encoding: "strict_bounded_canonical_json_utf8_v2",
    ...
    fields: [
      ...
      registryDocumentField("transactionIdentityHash", "nullable_sha256"),
      registryDocumentField(
  ...
  },
  {
    ...
    purpose: "offline_signed_exact_older_artifact_execution_exception_v2",
    encoding: "strict_bounded_canonical_json_utf8_v2",
    maxCanonicalBytes: 128 * 1024,
    productionUse: "forbidden",
    relationPolicy:
    ...
    fields: [
      ...
      registryDocumentField("targetPackageRef", "registered_package_ref"),
      registryDocumentField("targetArtifactHash", "sha256"),
      registryDocumentField("targetDistributionEpoch", "nonnegative_integer"),
...
const registryDocumentProtocolsV2 = registryDocumentProtocolIdentitiesV2.map(
  (identity) => ({
    ...identity,
    fields: identity.fields.map((field) => ({ ...field })),
    documentSchemaHash:
      hashPlatformReleaseBootstrapRegistryDocumentProtocolV2(identity),
  }),
);
...
const RegistryDocumentProtocolCatalogIdentityV2Schema = z
  .object({
    schema: z.literal(
    ...
    documents: z
      .array(PlatformReleaseBootstrapRegistryDocumentProtocolV2Schema)
      .length(PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_COUNT_V2),
  })
  .strict();
...
const registryDocumentProtocolCatalogIdentityV2 = {
  ...
  authorityRef:
    "AUTH_PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_CATALOG_V2",
  productionUse: "forbidden",
  documentCount: PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_COUNT_V2,
    ...
    .superRefine((value, context) => {
      ...
      if (
        ...
        canonicalJsonStringify(identity) !==
          canonicalJsonStringify(registryDocumentProtocolCatalogIdentityV2) ||
        value.catalogHash !==
        ...
        value.documents.some(
          (document, index) =>
            index > 0 &&
            value.documents[index - 1]!.schemaRef >= document.schemaRef,
        )
      ) {
        context.addIssue({
          code: "custom",
...
export type PlatformReleaseBootstrapRegistryDocumentProtocolCatalogV2 = z.infer<
  typeof PlatformReleaseBootstrapRegistryDocumentProtocolCatalogV2Schema
>;

export const PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_CATALOG_V2: PlatformReleaseBootstrapRegistryDocumentProtocolCatalogV2 =
  deepFreezePlatformReleaseJsonV2(
    PlatformReleaseBootstrapRegistryDocumentProtocolCatalogV2Schema.parse({
...
const PackageDirectoryV2Schema = z
  .object({
  ...
  .superRefine((value, context) => {
    if (
      value.orderedEntryRefs.length !== value.orderedEntryBasenames.length ||
      new Set(value.orderedEntryRefs).size !== value.orderedEntryRefs.length ||
      new Set(value.orderedEntryBasenames).size !==
        value.orderedEntryBasenames.length
    ) {
      context.addIssue({
        code: "custom",
        message: "Package directory entries must be unique one-to-one bindings",
      });
    }
  });

const PackageMemberV2Schema = z
  .object({
...
const LifecycleNamespaceV2Schema = z
  .object({
...
const PackageContractV2Schema = z
  .object({
...
const BootstrapRegistryV2Schema = z
  .object({
    ...
    filesystemScopeBasename: z.literal(
    ...
    documentProtocolCatalogHash: z.literal(
      PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_CATALOG_V2.catalogHash,
    ),
    packageCount: z.literal(PLATFORM_RELEASE_BOOTSTRAP_PACKAGE_COUNT_V2),
  })
  .strict();

const SystemParentV2Schema = z
  .object({
...
const SystemLogicalBindingV2Schema = z
  .object({
...
const SystemAnchorContractV2Schema = z
  .object({
    policy: z.literal(
      "two_exact_parents_four_physical_files_five_logical_roles_v2",
    ),
    verifierAbiRef: z.literal("ABI_PLATFORM_RELEASE_VERIFY_SYSTEM_ANCHORS_V2"),
...
const RuntimeAccountContractV2Schema = z
  .object({
    ...
    uidGidPolicy: z.literal("lowest_equal_free_uid_gid_in_code_owned_range_v2"),
    minimumUidGid: z.literal(600),
    maximumUidGid: z.literal(699),
    lookupAbiRef: z.literal("ABI_PLATFORM_RELEASE_LOOKUP_LOCAL_ACCOUNT_V2"),
    ...
    adoptionPolicy: z.literal("receipt_or_matching_active_preclaim_only_v2"),
  })
  .strict();

const ProductionTrustRequirementV2Schema = z
  .object({
    authorityState: z.literal("production_trust_configuration_unavailable"),
    productionAdmission: z.literal("forbidden"),
    externalRoot: z.literal("notarized_developer_id_installer_plus_amfi_v2"),
    signatureAlgorithm: z.literal("ed25519"),
    requiredArchitectures: z.tuple([z.literal("arm64"), z.literal("x64")]),
    requiredNativePackageRefs: z.tuple([
      z.literal(PLATFORM_RELEASE_BOOTSTRAP_PACKAGE_REFS_V2.hostVerifier),
      z.literal(
...
const PlatformReleaseBootstrapContractIdentityV2Schema = z
  .object({
...
export type PlatformReleaseBootstrapContractHashPayloadV2 = z.infer<
  typeof PlatformReleaseBootstrapContractIdentityV2Schema
>;
...
const nodePackageV2 = {
  ...
  rootMode: "0555",
  distributionPolicy: "existing_authenticated_node_bootstrap_v2",
  ...
  members: [
    {
      ...
      relativeLocator: NODE_TOOLCHAIN_PROVISIONER_BOOTSTRAP_MANIFEST_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_NODE_ROOT_DIRECTORY_V2",
      mediaType: "application/json",
      requiredMode: "0444",
      requiredLinkCount: 1,
      maxBytes: NODE_TOOLCHAIN_PROVISIONER_BOOTSTRAP_MAX_MANIFEST_BYTES_V2,
      requiredExports: [],
    },
    {
      memberRef: "BOOTSTRAP_NODE_LAUNCHER_V2",
      role: "node_launcher",
      relativeLocator: NODE_TOOLCHAIN_PROVISIONER_BOOTSTRAP_LAUNCHER_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_NODE_BIN_DIRECTORY_V2",
      mediaType: "text/x-shellscript",
      requiredMode: "0555",
      requiredLinkCount: 1,
      maxBytes: NODE_TOOLCHAIN_PROVISIONER_BOOTSTRAP_MAX_LAUNCHER_BYTES_V2,
      requiredExports: [],
    },
    {
      memberRef: "BOOTSTRAP_NODE_BUNDLE_V2",
      role: "node_bundle",
      relativeLocator: NODE_TOOLCHAIN_PROVISIONER_BOOTSTRAP_BUNDLE_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_NODE_LIB_DIRECTORY_V2",
      mediaType: "application/javascript",
      requiredMode: "0444",
      requiredLinkCount: 1,
      maxBytes: NODE_TOOLCHAIN_PROVISIONER_BOOTSTRAP_MAX_BUNDLE_BYTES_V2,
      requiredExports: [],
    },
    {
      memberRef: "BOOTSTRAP_NODE_RUNTIME_V2",
      role: "node_runtime",
      relativeLocator: NODE_TOOLCHAIN_PROVISIONER_BOOTSTRAP_RUNTIME_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_NODE_RUNTIME_DIRECTORY_V2",
      mediaType: "application/x-mach-binary",
      requiredMode: "0555",
      requiredLinkCount: 1,
      maxBytes: NODE_TOOLCHAIN_PROVISIONER_BOOTSTRAP_MAX_RUNTIME_BYTES_V2,
      requiredExports: [],
    },
  ],
  lifecycle: {
...
const hostVerifierPackageV2 = {
  ...
  manifestLocator: PLATFORM_RELEASE_HOST_VERIFIER_MANIFEST_LOCATOR_V2,
  productionOwnerUid: 0,
  productionOwnerGid: 0,
  rootMode: "0555",
  distributionPolicy: "signed_installer_native_distribution_v2",
  verifierPolicy: "amfi_self_attest_then_descriptor_revalidation_v2",
  directories: [
    {
    ...
    },
    {
      ...
      relativeLocator: "bin",
      requiredMode: "0555",
      orderedEntryRefs: ["BOOTSTRAP_HOST_VERIFIER_EXECUTABLE_V2"],
      orderedEntryBasenames: [
        path.posix.basename(
  ...
  members: [
    {
      ...
      role: "canonical_manifest",
      relativeLocator: PLATFORM_RELEASE_HOST_VERIFIER_MANIFEST_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_HOST_VERIFIER_ROOT_DIRECTORY_V2",
      mediaType: "application/json",
      requiredMode: "0444",
      requiredLinkCount: 1,
    ...
    },
    {
      ...
      relativeLocator: PLATFORM_RELEASE_HOST_VERIFIER_EXECUTABLE_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_HOST_VERIFIER_BIN_DIRECTORY_V2",
      mediaType: "application/x-mach-binary",
      requiredMode: "0555",
      requiredLinkCount: 1,
  ...
  lifecycle: {
    ...
    stagingPrefix: ".setfarm-host-composition-verifier-v2.installation.staging",
    rollbackClaimBasename:
...
const releaseCompositionPackageV2 = {
  ...
  authorityRef: "AUTH_PLATFORM_RELEASE_COMPOSITION_PACKAGE_V2",
  root: PLATFORM_RELEASE_COMPOSITION_PACKAGE_ROOT_V2,
  rootBasename: "platform-release-composition-v2",
  manifestLocator: PLATFORM_RELEASE_COMPOSITION_PACKAGE_MANIFEST_LOCATOR_V2,
  productionOwnerUid: 0,
  productionOwnerGid: 0,
  rootMode: "0555",
  distributionPolicy: "authenticated_platform_release_build_v2",
  verifierPolicy: "installed_native_verifier_v2",
  directories: [
    {
      directoryRef: "BOOTSTRAP_RELEASE_COMPOSITION_ROOT_DIRECTORY_V2",
      relativeLocator: ".",
      requiredMode: "0555",
      orderedEntryRefs: [
    ...
    {
      directoryRef: "BOOTSTRAP_RELEASE_COMPOSITION_BIN_DIRECTORY_V2",
      relativeLocator: "bin",
      requiredMode: "0555",
      orderedEntryRefs: ["BOOTSTRAP_RELEASE_COMPOSITION_EXECUTABLE_V2"],
      orderedEntryBasenames: [
        path.posix.basename(PLATFORM_RELEASE_COMPOSITION_EXECUTABLE_LOCATOR_V2),
      ],
    },
    {
      directoryRef: "BOOTSTRAP_RELEASE_COMPOSITION_LIB_DIRECTORY_V2",
      relativeLocator: "lib",
      requiredMode: "0555",
      orderedEntryRefs: [
      ...
      orderedEntryBasenames: [
        path.posix.basename(PLATFORM_RELEASE_COMPOSITION_MODULE_LOCATOR_V2),
        path.posix.basename(PLATFORM_RELEASE_METADATA_MODULE_LOCATOR_V2),
        path.posix.basename(PLATFORM_RELEASE_NETWORK_WRAPPER_MODULE_LOCATOR_V2),
      ],
    },
  ],
  members: [
    {
      ...
      role: "canonical_manifest",
      relativeLocator: PLATFORM_RELEASE_COMPOSITION_PACKAGE_MANIFEST_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_RELEASE_COMPOSITION_ROOT_DIRECTORY_V2",
      mediaType: "application/json",
      requiredMode: "0444",
      requiredLinkCount: 1,
      maxBytes: MAX_BOOTSTRAP_MANIFEST_BYTES_V2,
    ...
    },
    {
      ...
      relativeLocator: PLATFORM_RELEASE_COMPOSITION_EXECUTABLE_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_RELEASE_COMPOSITION_BIN_DIRECTORY_V2",
      mediaType: "application/javascript",
      requiredMode: "0555",
      requiredLinkCount: 1,
    ...
    },
    {
      ...
      role: "release_module",
      relativeLocator: PLATFORM_RELEASE_COMPOSITION_MODULE_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_RELEASE_COMPOSITION_LIB_DIRECTORY_V2",
      mediaType: "application/javascript",
      requiredMode: "0444",
      requiredLinkCount: 1,
      maxBytes: MAX_RELEASE_MODULE_BYTES_V2,
    ...
    },
    {
      ...
      relativeLocator: PLATFORM_RELEASE_METADATA_MODULE_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_RELEASE_COMPOSITION_LIB_DIRECTORY_V2",
      mediaType: "application/javascript",
      requiredMode: "0444",
      requiredLinkCount: 1,
      maxBytes: MAX_RELEASE_MODULE_BYTES_V2,
      requiredExports: ["runPlatformReleaseMetadataProbeV2"],
    },
    {
      memberRef: "BOOTSTRAP_RELEASE_COMPOSITION_NETWORK_WRAPPER_MODULE_V2",
      role: "network_wrapper_module",
      relativeLocator: PLATFORM_RELEASE_NETWORK_WRAPPER_MODULE_LOCATOR_V2,
      parentDirectoryRef: "BOOTSTRAP_RELEASE_COMPOSITION_LIB_DIRECTORY_V2",
      mediaType: "application/javascript",
      requiredMode: "0444",
      requiredLinkCount: 1,
      maxBytes: MAX_RELEASE_MODULE_BYTES_V2,
      requiredExports: ["runPlatformReleaseNetworkNegativeProbeV2"],
    },
  ],
  lifecycle: {
    activeReceiptBasename:
...
const runtimeAccountProvisionerPackageV2 = {
  packageRef:
    PLATFORM_RELEASE_BOOTSTRAP_PACKAGE_REFS_V2.runtimeAccountProvisioner,
  packageKind: "signed_native_leaf",
  authorityRef: "AUTH_PLATFORM_RELEASE_RUNTIME_ACCOUNT_PROVISIONER_PACKAGE_V2",
  ...
  directories: [
    {
      directoryRef: "BOOTSTRAP_RUNTIME_ACCOUNT_PROVISIONER_ROOT_DIRECTORY_V2",
      relativeLocator: ".",
      requiredMode: "0555",
      orderedEntryRefs: [
    ...
    {
      directoryRef: "BOOTSTRAP_RUNTIME_ACCOUNT_PROVISIONER_BIN_DIRECTORY_V2",
      relativeLocator: "bin",
      requiredMode: "0555",
      orderedEntryRefs: ["BOOTSTRAP_RUNTIME_ACCOUNT_PROVISIONER_EXECUTABLE_V2"],
      orderedEntryBasenames: [
        path.posix.basename(
  ...
  members: [
    {
      memberRef: "BOOTSTRAP_RUNTIME_ACCOUNT_PROVISIONER_MANIFEST_V2",
      role: "canonical_manifest",
      relativeLocator:
        PLATFORM_RELEASE_RUNTIME_ACCOUNT_PROVISIONER_MANIFEST_LOCATOR_V2,
      parentDirectoryRef:
    ...
    {
      memberRef: "BOOTSTRAP_RUNTIME_ACCOUNT_PROVISIONER_EXECUTABLE_V2",
      role: "signed_native_executable",
      relativeLocator:
        PLATFORM_RELEASE_RUNTIME_ACCOUNT_PROVISIONER_EXECUTABLE_LOCATOR_V2,
      parentDirectoryRef:
...
const contractIdentityV2 = {
  ...
  version: PLATFORM_RELEASE_COMPONENT_VERSION_V2,
  authorityRef: PLATFORM_RELEASE_BOOTSTRAP_CONTRACT_AUTHORITY_REF_V2,
  authorityState: "code_owned_contract_production_trust_unconfigured",
  productionUse:
    "forbidden_until_signed_distribution_and_registry_activation_exist",
  registry: {
    parent: PLATFORM_RELEASE_BOOTSTRAP_PARENT_V2,
    registryRef: "BOOTSTRAP_PACKAGE_REGISTRY_V2",
    namespacePolicy: "exact_registered_siblings_unknown_and_ambiguous_fail_v2",
    cutoverPolicy:
      "legacy_node_lock_then_shared_activation_then_shared_package_order_v2",
    filesystemScopeBasename:
      PLATFORM_RELEASE_BOOTSTRAP_FILESYSTEM_SCOPE_DOCUMENT_BASENAME_V2,
    sharedLockBasename:
      PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_SHARED_LOCK_BASENAME_V2,
    ...
    activationReceiptBasename:
      PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_ACTIVATION_RECEIPT_BASENAME_V2,
    activationClaimBasename:
      PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_ACTIVATION_CLAIM_BASENAME_V2,
    transactionStagingBasename:
      PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_TRANSACTION_STAGING_BASENAME_V2,
    activationMigratorProtocolHash:
      PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_ACTIVATION_MIGRATOR_PROTOCOL_HASH_V2,
    epochFloorBasename:
      PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_EPOCH_FLOOR_BASENAME_V2,
    epochClaimBasename:
  ...
  systemAnchors: {
    ...
    verifierAbiRef: "ABI_PLATFORM_RELEASE_VERIFY_SYSTEM_ANCHORS_V2",
    parents: [
      {
  ...
  productionTrust: {
    authorityState: "production_trust_configuration_unavailable",
    productionAdmission: "forbidden",
    externalRoot: "notarized_developer_id_installer_plus_amfi_v2",
...
function exactContractIssue(
  ...
  const globalBasenames = [
    value.registry.filesystemScopeBasename,
    value.registry.sharedLockBasename,
    value.registry.activationReceiptBasename,
    value.registry.activationClaimBasename,
    value.registry.transactionStagingBasename,
  ...
  for (const packageContract of value.packages) {
    const rootDirectories = packageContract.directories.filter(
      (entry) => entry.relativeLocator === ".",
    );
    const directoryByRef = new Map(
      packageContract.directories.map((entry) => [entry.directoryRef, entry]),
    );
    const memberByRef = new Map(
      packageContract.members.map((entry) => [entry.memberRef, entry]),
    );
    const observedEntryRefs = packageContract.directories.flatMap(
      (entry) => entry.orderedEntryRefs,
    );
    ...
    if (
      ...
      new Set(packageContract.directories.map((entry) => entry.directoryRef))
        .size !== packageContract.directories.length ||
      new Set(packageContract.members.map((entry) => entry.memberRef)).size !==
        packageContract.members.length ||
      new Set(packageContract.members.map((entry) => entry.relativeLocator))
        .size !== packageContract.members.length ||
      observedEntryRefs.length !== expectedEntryRefs.length ||
      new Set(observedEntryRefs).size !== observedEntryRefs.length ||
      expectedEntryRefs.some(
        (entryRef) => !observedEntryRefs.includes(entryRef),
      ) ||
      packageContract.directories.some((directory) =>
        directory.orderedEntryBasenames.some(
          (basename, index) =>
            index > 0 &&
        ...
        directory.orderedEntryRefs.some((entryRef, index) => {
          ...
          const expectedBasename = childDirectory
            ...
            : member
              ...
              : undefined;
          return expectedBasename !== directory.orderedEntryBasenames[index];
        }),
      ) ||
      packageContract.members.some((member) => {
        ...
        return (
          !parent ||
          path.posix.dirname(member.relativeLocator) !== parent.relativeLocator
        );
      }) ||
      !packageContract.members.some(
        (member) =>
  ...
  for (const operation of PLATFORM_RELEASE_BOOTSTRAP_OPERATION_ABI_SET_V2.operations) {
    ...
    const processExecutable = ownerPackage?.members.find(
      (member) => member.memberRef === operation.processExecutableMemberRef,
    );
    const implementation = ownerPackage?.members.find(
      (member) => member.memberRef === operation.implementationMemberRef,
    );
    ...
    const interpreter =
      operation.interpreterMemberRef === null
        ...
        : interpreterPackage?.members.find(
            (member) => member.memberRef === operation.interpreterMemberRef,
          );
    ...
    if (
      ...
      (operation.moduleExport === null
        ...
        : !implementation.requiredExports.includes(operation.moduleExport))
    ) {
  ...
  if (
    parentRefs.size !== 2 ||
    fileRefs.size !== 4 ||
    value.systemAnchors.files.some(
      (entry) =>
        !parentRefs.has(entry.parentRef) ||
        path.posix.dirname(entry.absoluteLocator) !==
          value.systemAnchors.parents.find(
            (parent) => parent.parentRef === entry.parentRef,
          )?.absoluteLocator,
    ) ||
    value.systemAnchors.logicalBindings.some(
      (entry) => !fileRefs.has(entry.fileRef),
    )
  ) {
    return "Bootstrap fixed system-anchor topology is incomplete";
  }
  const xattrBindings = value.systemAnchors.logicalBindings.filter((entry) =>
  ...
  PlatformReleaseBootstrapContractIdentityV2Schema.extend({
    ...
    .superRefine((value, context) => {
      ...
      if (
        ...
        value.contractHash !== hashPlatformReleaseBootstrapContractV2(identity)
      ) {
        context.addIssue({
          code: "custom",
          path: ["contractHash"],
...
export type PlatformReleaseBootstrapContractV2 = z.infer<
  typeof PlatformReleaseBootstrapContractV2Schema
>;

export const PLATFORM_RELEASE_BOOTSTRAP_CONTRACT_V2: PlatformReleaseBootstrapContractV2 =
  deepFreezePlatformReleaseJsonV2(
    PlatformReleaseBootstrapContractV2Schema.parse({
      ...contractIdentityV2,
      contractHash: hashPlatformReleaseBootstrapContractV2(contractIdentityV2),
    }),
  );

export function getPlatformReleaseBootstrapContractV2(): PlatformReleaseBootstrapContractV2 {
  return deepFreezePlatformReleaseJsonV2(
    structuredClone(PLATFORM_RELEASE_BOOTSTRAP_CONTRACT_V2),
  );
}

export function getPlatformReleaseBootstrapRegistryDocumentProtocolCatalogV2(): PlatformReleaseBootstrapRegistryDocumentProtocolCatalogV2 {
  return deepFreezePlatformReleaseJsonV2(
    structuredClone(
...
export function getPlatformReleaseBootstrapRegistryDocumentProtocolV2(
  ...
  const found =
    PLATFORM_RELEASE_BOOTSTRAP_REGISTRY_DOCUMENT_PROTOCOL_CATALOG_V2.documents.find(
      (entry) => entry.schemaRef === schemaRef,
    );
  if (!found) {
    throw new TypeError("Registry document schema reference is not code-owned");
  }
...
export function parsePlatformReleaseBootstrapRegistryDocumentProtocolCandidateV2(
  ...
  return deepFreezePlatformReleaseJsonV2(
    PlatformReleaseBootstrapRegistryDocumentProtocolV2Schema.parse(snapshot),
  );
}
