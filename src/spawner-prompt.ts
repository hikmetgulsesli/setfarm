...
try {
  ...
  const script = [
    ...
    "  if (command === 'retry-feedback' && value && typeof value === 'object' && !Array.isArray(value)) {",
    "    const out = {};",
...
lines.push("DETAILS_RULE=Initial bootstrap output intentionally omits long story, retry, PR, and supervisor text. Use only the printed SUMMARY_*_CMD commands for details; story brief lives in current-story/acceptance, not a story-brief helper topic.");
