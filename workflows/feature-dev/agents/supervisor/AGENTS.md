...
6. Update supervisor memory in your output with what you checked, what you changed, and residual risk. Treat this file as the durable manager session for the whole run.
