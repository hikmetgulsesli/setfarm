...
const BUILD_TOPOLOGY_CONTRACT_HASH_GOLDEN_V3_1 =
  "3f4ab4b48a3eeee55d7bbd0dfc36d7d20989975c8257b1be44b6d35fc0b33614";

describe("BuildTopologyV3.1 receipt authority", () => {
  it("uses the only implemented candidate build and evidence receipt schemas", () => {
    assert.equal(BUILD_TOPOLOGY_VERSION_V3, "3.1.0");
    assert.equal(
      BUILD_TOPOLOGY_CONTRACT_HASH_V3,
      BUILD_TOPOLOGY_CONTRACT_HASH_GOLDEN_V3_1,
    );
