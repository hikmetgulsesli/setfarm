...
describe("OA17 zero-input current Setfarm source/build observation", () => {
  ...
  it("P4 service census resolves the two fixed Setfarm launchers through detached daemon authority", () => {
    ...
    for (const fault of ["launch_running", "launch_args", "launch_path", "launch_program", "launch_environment", "extra_environment", "inherited_preload", "crossed_env_dir", "plist_args", "zero", "multiple", "multiple_after", "wrong_uid", "selected_nobody", "wrong_ppid", "wrong_pgid", "zombie", "wrong_args", "wrong_comm", "drift", "cli_drift", "partial_lsof", "listener_missing", "listener_multiple", "listener_cross"]) {
