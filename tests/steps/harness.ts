...
export function validPlanOutput(overrides: Partial<ParsedOutput> = {}): ParsedOutput {
  return {
    ...
    ui_vision_summary: "Test App should feel like a focused note operations product with compact working surfaces, visible local state, clear validation, and useful recovery feedback. Stitch should use only the declared note workspace and editor surfaces, not marketing pages or unrelated admin modules.",
    prd: "# Test App Product Contract\n\n" +
      ...
      "## 6. System Contracts\n### environment_contract\n- Required Keys: none.\n- Optional Keys: none.\n- Secret Handling: MC/runtime supplies values; PLAN never emits values.\n- Client Exposed Keys: none.\n- Missing Key Behavior: not applicable.\n- External Integrations: none.\n- Permission Model: anonymous local user.\n- Security: no secrets in client state.\n\n" +
      "## 7. Platform Contract\n- Type: Web\n- Rendering Strategy: CSR for Vite React.\n- Auth Storage: none.\n- Test Surface: window.app is allowed for deterministic smoke/final-test inspection.\n### route_guard_policy\n- Protected Surfaces: none.\n- Public Surfaces: SURF_WORKSPACE, SURF_NOTE_EDITOR.\n- Redirect On Unauthorized: not applicable.\n- Guard Implementation Owner: app shell story owns router/surface plumbing only.\n\n" +
